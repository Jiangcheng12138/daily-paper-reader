...
title_zh: 昼夜节律对自发性多巴胺释放的调节塑造了伏隔核中的奖赏诱发信号
authors: "Cook, J. N., Gevorgyan, M., Armitage, J., Jones, J."
date: 2026-04-24
pdf: "https://www.biorxiv.org/content/10.64898/2026.04.22.720003v1.full.pdf"
tags: ["query:slp-ns"]
score: 7.0
evidence: 多巴胺释放的昼夜节律调节
tldr: 本研究探讨了昼夜节律如何调节伏隔核中的多巴胺（DA）释放及其对奖励行为的影响。通过长期光纤记录和自动奖励系统，研究发现自发性DA释放与奖励诱发性DA释放具有不同的昼夜节律，且两者呈负相关。昼夜节律通过调节基线DA水平来改变奖励信号的增益，从而在特定时间放大行为相关的多巴胺反应，揭示了生物钟优化奖励处理的神经机制。
source: biorxiv
selection_source: fresh_fetch
motivation: 旨在阐明昼夜节律如何通过调节伏隔核多巴胺释放的不同模式来影响奖励处理和相关行为。
method: 采用长期光纤记录技术结合自动化奖励输送系统，对小鼠伏隔核中的多巴胺释放和奖励行为进行持续监测与建模分析。
result: 发现自发性DA和奖励诱发性DA具有不同的昼夜节律峰值，且基线DA水平与奖励诱发反应之间存在受昼夜节律调控的负相关性。
conclusion: 昼夜节律通过调节基线多巴胺水平来改变奖励信号的增益，从而在行为活跃期优化大脑对奖励的反应灵敏度。
---

## 摘要
昼夜节律系统是奖赏相关神经功能和行为的重要调节器。伏隔核中的多巴胺 (DA) 释放是奖赏处理的关键组成部分，然而昼夜节律定时如何塑造与奖赏行为相关的 DA 释放仍不清楚。在本研究中，我们利用长期光纤光度法结合自动化奖赏交付和测量系统，研究了 DA 释放和奖赏行为中的昼夜节律。我们发现了 DA 释放中两种截然不同的昼夜节律：自发性 DA（反映与奖赏无关的持续 DA 释放）和奖赏诱发性 DA（反映奖赏期间的瞬时 DA 反应）。自发性 DA 在主观白昼早期达到峰值，而奖赏诱发性 DA 峰值则在昼夜交替附近达到峰值。这两种节律都与奖赏行为不同，后者在主观黑夜早期达到峰值。线性建模进一步表明，奖赏诱发性 DA 与奖赏行为之间的关系取决于昼夜节律时间，在主观白昼后期到主观黑夜早期之间会出现更强的 DA 反应。自发性基线 DA 与奖赏诱发性 DA 也呈负相关，且这种关系同样受到昼夜节律时间的调节。总之，这些发现支持了一个模型，即基线 DA 的昼夜节律调节可能会改变奖赏诱发信号的增益，从而在一天中具有行为相关性的时间段内放大 DA 反应。
