...
tldr: 本研究探讨了前驱期帕金森病（PD）的炎症机制，假设其起源于肠道并演变为神经退行性变。通过对118名受试者的脑脊液和血液进行单细胞测序，发现前驱期PD患者脑脊液中免疫细胞增加，特别是具有JAK-STAT和TNF信号特征的类小胶质巨噬细胞。研究揭示了肠道与中枢神经系统之间的免疫联系，为PD的早期干预提供了新靶点。
source: biorxiv
selection_source: fresh_fetch
motivation: 验证前驱期帕金森病是否为一种起源于肠道并演变为神经退行性病变的炎症性疾病。
method: 对118名受试者（包括健康对照、前驱期PD、确诊PD及多发性硬化症患者）的脑脊液和血液进行单细胞转录组测序分析。
result: 发现前驱期PD患者脑脊液中类小胶质巨噬细胞显著增加，且表现出增强的TNF和JAK-STAT信号特征，并证实了肠道与脑脊液间存在共享的T细胞克隆。
conclusion: 研究揭示了前驱期PD中由髓系细胞驱动的炎症过程，并证实了肠道与中枢神经系统之间的免疫关联。
---
