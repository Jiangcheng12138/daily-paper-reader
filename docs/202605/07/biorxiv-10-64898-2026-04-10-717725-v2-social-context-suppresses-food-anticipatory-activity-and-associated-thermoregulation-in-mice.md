...
title_zh: 社会环境抑制小鼠的摄食预测性活动及相关的体温调节
authors: "Paik, A., Trzeciak, J., Harrington, C., Steele, A."
date: 2026-04-30
pdf: "https://www.biorxiv.org/content/10.64898/2026.04.10.717725v2.full.pdf"
tags: ["query:tr-hb"]
score: 6.0
evidence: 社会环境对体温调节和活动的影响
tldr: 本研究探讨了社交环境对小鼠食物预期活动（FAA）的影响。传统研究多关注单笼饲养，而本研究通过植入式无线设备监测群居小鼠，发现社交环境显著抑制了雌雄小鼠的FAA及餐前体温升高。这表明FAA不仅受昼夜节律驱动，还受社交背景和能量需求调节，揭示了社交因素在食物诱导的生物节律中的重要作用。
source: biorxiv
selection_source: fresh_fetch
motivation: 以往关于食物预期活动（FAA）的研究大多局限于单笼饲养环境，忽视了社交背景对这种昼夜节律行为的影响。
method: 研究人员利用植入式无线设备，对比监测了群居和单笼饲养小鼠在定时喂养前的个体运动活动及皮下体温变化。
result: 实验结果显示，社交群居显著抑制了雌性和雄性小鼠的食物预期活动，并明显减弱了其餐前的体温升高现象。
conclusion: 研究证明FAA是一种灵活且状态依赖的行为，社交环境是影响食物诱导的昼夜节律生物学特征的重要决定因素。
---

## 摘要
摄食预测性活动（FAA）是食物诱导的昼夜节律中一种稳健的行为输出，其特征是在预定喂食前自主活动增加。尽管啮齿动物具有社会属性，但 FAA 几乎仅在单笼饲养的动物中进行研究，这使得社会环境的影响在很大程度上尚未得到探索。在本研究中，我们使用植入式无线设备测量了群居小鼠的个体自主活动和皮下体温，并将这些指标与单笼饲养的对照组进行了比较。结果显示，社会化群居显著抑制了雄性和雌性小鼠的 FAA。与此同时，群居动物餐前的体温升高也明显减弱。这些发现表明，FAA 是一种灵活的、状态依赖性的行为，反映了昼夜节律定时和能量需求。总之，这些结果表明社会环境是食物诱导的昼夜节律生物学中一个重要且被低估的决定因素。
