...
title_zh: 淀粉样蛋白斑块驱动海马体中状态依赖性的长程环路重组
authors: "Zhao, Z., Joseph, L. J., Li, H., Gowravaram, N., Green, R. J., Kastanenka, K., Bacskai, B., Hyman, B. T., Gomperts, S. N."
date: 2026-04-27
pdf: "https://www.biorxiv.org/content/10.64898/2026.04.22.720180v2.full.pdf"
tags: ["query:slp-ns"]
score: 7.0
evidence: 研究了不同行为和睡眠状态下的海马体活动
tldr: 本研究探讨了阿尔茨海默病中淀粉样蛋白斑块对海马体神经环路的影响。通过对自由活动小鼠进行长期钙成像和斑块成像，发现斑块具有依赖于行为状态的长程效应，导致位置细胞在斑块附近异常富集并重组空间地图。研究还发现慢波睡眠期间的神经过度活跃可预测未来斑块的沉积，揭示了病理斑块破坏海马功能架构的机制。
source: biorxiv
selection_source: fresh_fetch
motivation: 旨在探究淀粉样蛋白斑块如何影响自由活动动物的海马体功能图谱以及神经环路的重组过程。
method: 结合单光子钙成像、局部场电位记录和双光子斑块成像技术，对APP/PS1小鼠在不同行为和睡眠状态下进行纵向监测。
result: 斑块引起了海马活动的非局部重组，使位置细胞在斑块周围异常聚集，且睡眠时的过度活跃预示了未来斑块的沉积位置。
conclusion: 淀粉样病变通过重组脑环路破坏了海马体的功能架构，是导致阿尔茨海默病广泛功能障碍和认知受损的关键机制。
---

## 摘要
淀粉样蛋白斑块是阿尔茨海默病的病理特征，但它们如何驱动广泛的神经元功能障碍仍不清楚。虽然在麻醉动物中的研究表明斑块会驱动局部过度活跃，但这种病理如何塑造自由活动动物的海马功能图谱尚不清楚。我们结合了慢性单光子钙成像、局部场电位记录以及对自由活动 APP/PS1 小鼠在行为和睡眠期间的后期双光子斑块成像，以将实时海马活动和位置编码与精确的斑块拓扑结构联系起来。在此，我们展示了斑块对海马活动产生非局部的长程影响，这些影响取决于斑块的大小、层状位置以及动物的行为状态。编码空间位置且通常均匀分布的位置细胞，优先富集在斑块附近，揭示了斑块相邻神经元异常重组进入海马空间图谱的过程。在纵向实验中，预先存在的位置细胞位置并不能预测未来的斑块位点，而慢波睡眠期间的过度活跃则能微弱地预测未来的淀粉样蛋白沉积。这些发现确定了一种淀粉样蛋白病理重组大脑环路的机制，该机制破坏了海马的功能结构，并导致了阿尔茨海默病中广泛的功能障碍和认知障碍。
