---
title: "Amyloid plaques drive long-range circuit reorganization in a mouse model of Alzheimer's disease"
title_zh: 淀粉样蛋白斑块驱动阿尔茨海默病小鼠模型中的远距离回路重组
authors: "Zhao, Z., Joseph, L. J., Li, H., Gowravaram, N., Green, R. J., Kastanenka, K., Bacskai, B., Hyman, B. T., Gomperts, S. N."
date: 2026-04-23
pdf: "https://www.biorxiv.org/content/10.64898/2026.04.22.720180v1.full.pdf"
tags: ["query:slp-ns"]
score: 7.0
evidence: 阿尔茨海默病模型中跨行为和睡眠的海马活动
tldr: 本研究利用单光子钙成像和双光子斑块成像技术，在自由活动的APP/PS1小鼠中探究了淀粉样蛋白斑块对海马回路的影响。研究发现，斑块不仅引起局部异常，还具有长程效应，导致位置细胞在斑块附近异常富集，重组了海马空间地图。此外，慢波睡眠期间的过度活跃可微弱预测未来斑块的沉积。该研究揭示了淀粉样病变重组脑回路并导致认知功能障碍的机制。
source: biorxiv
selection_source: fresh_fetch
motivation: 旨在阐明淀粉样蛋白斑块如何影响自由活动动物的海马功能图谱及长程神经回路的重组。
method: 结合慢性单光子钙成像、局部场电位记录和事后双光子斑块成像，在APP/PS1小鼠的行为和睡眠状态下进行多维度观察。
result: 发现斑块导致位置细胞在斑块附近异常富集，且斑块对海马活动具有依赖于大小、位置和行为状态的长程影响。
conclusion: 淀粉样病变通过重组脑回路和破坏海马功能架构，导致了阿尔茨海默病中广泛的神经功能障碍和认知受损。
---

## 摘要
淀粉样蛋白斑块是阿尔茨海默病的病理特征，但它们如何驱动广泛的神经元功能障碍仍不清楚。虽然在麻醉动物中的研究表明斑块会驱动局部过度活跃，但在自由活动的动物中，这种病理如何塑造功能性海马图谱尚不清楚。我们结合了慢性单光子钙成像、局部场电位记录以及在自由活动的 APP/PS1 小鼠行为和睡眠期间的事后双光子斑块成像，以将实时海马活动和位置编码与精确的斑块拓扑结构联系起来。在这里，我们展示了斑块对海马活动产生非局部的、远距离的影响，这些影响取决于斑块的大小、层状位置以及动物的行为状态。位置细胞负责编码空间位置且通常均匀分布，但它们在斑块附近优先富集，揭示了斑块相邻神经元异常重组进入海马空间图谱。在纵向实验中，预先存在的位置细胞位置并不能预测未来的斑块位点，而慢波睡眠期间的过度活跃则能微弱地预测未来的淀粉样蛋白沉积。这些发现确定了淀粉样蛋白病理重组脑回路的一种机制，这种机制退化了海马的功能结构，并导致了阿尔茨海默病中广泛的功能障碍和认知障碍。
