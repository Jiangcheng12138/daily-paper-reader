---
title: Divergent molecular and circuit mechanisms underlie light entrainment of retinal and suprachiasmatic nucleus circadian clocks
title_zh: 差异化的分子和环路机制介导了视网膜和视交叉上核昼夜节律钟的光夹带
authors: "Jandot, A., Calligaro, H., Dianak-Shoori, A., Tartour, K., Sandu, C., Haddjeri, N., Ribelayga, C. P., Ananthasubramaniam, B., Padmanabhan, K., Felder-Schmittbuhl, M.-P., Dkhissi-Benyahya, O."
date: 2026-04-30
pdf: "https://www.biorxiv.org/content/10.64898/2026.04.27.721075v1.full.pdf"
tags: ["query:slp-ns"]
score: 8.0
evidence: 视交叉上核昼夜节律钟的电路机制
tldr: 本研究探讨了视网膜和视交叉上核（SCN）昼夜节律钟在光夹带机制上的差异。通过对不同光感受器缺失小鼠的转录组分析，发现两者虽共享部分视杆细胞驱动的基因，但光诱导的转录反应对视网膜时钟相位移动有效，而对SCN无效。研究进一步确定了OFF型视锥双极细胞环路是视网膜时钟相位重置的关键，揭示了两者在光计时机制上的根本分歧。
source: biorxiv
selection_source: fresh_fetch
motivation: 旨在阐明视网膜和SCN这两个昼夜节律钟在光感受器输入和光敏感度方面的差异及其背后的分子与环路机制。
method: 利用缺乏特定光感受器或信号通路组件的小鼠模型，结合转录组学分析、遗传阻断和药理学手段进行综合比较研究。
result: 发现视网膜和SCN具有不同的光响应转录特征，且视网膜时钟的相位重置依赖于OFF型视锥双极细胞环路，而SCN的转录反应不足以引起相位移动。
conclusion: 研究揭示了视网膜特有的昼夜节律夹带环路，并证明了视网膜与SCN在光计时机制上存在显著的分子和环路差异。
---

## 摘要
昼夜节律系统通过一个分布式的生物钟网络使行为和生理与24小时环境周期保持一致，该网络包括视交叉上核（SCN）中的主起搏器和对局部视网膜生理及功能至关重要的自主视网膜钟。尽管这两个生物钟都受光夹带，但它们在光感受器输入和光敏感度方面存在差异。然而，不同光感受器通路驱动其光夹带的具体贡献和机制仍不完全清楚。在本研究中，我们利用缺乏特定光感受器或信号通路关键组件的小鼠模型，对视网膜和 SCN 的昼夜节律光反应进行了全面的转录组学和综合比较分析。在明视觉条件下，我们发现不同基因型的每种组织都表现出独特的光响应转录特征，但两者都共享一组保守的视杆细胞驱动的即刻早期基因。令人惊讶的是，光诱发的转录反应不足以改变 SCN 生物钟的相位，这与其对视网膜生物钟强大的相位移动作用形成鲜明对比。此外，通过遗传手段阻断视杆/视锥细胞电耦合以及药理学手段分离视杆通路，我们确定 OFF-型视锥双极细胞环路对于介导光诱导的视网膜钟相位重置既是必要的也是充分的。总之，这些发现描绘了作为昼夜节律夹带基础的专门视网膜环路，并揭示了视网膜和 SCN 在光计时机制上的根本差异。
